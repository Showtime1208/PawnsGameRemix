...
/**
 * Strategy Representation representing the strategy of controlling the most
 * squares on the board. The Strategy breaks ties by selecting the uppermost, then the
 * leftmost board position. For the hand, the strategy breaks ties by taking the left
 * most card.
 */
public class BoardControlStrategy implements Strategy {
  ...
  protected Cell[][] testPlacement(Board board,
                                   Player player, Card card, int handIdx, int row, int col) {
  ...
  private void applyInfluenceOnCellArray(Player player,
                                         Card card, Cell[][] board, int placedRow, int placedCol) {
