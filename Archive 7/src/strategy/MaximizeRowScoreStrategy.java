...
/**
 * Strategy implementation representing the strategy of maximizing the row score.
 * The strategy will go from top to bottom, looking for any rows where the Player
 * is losing or even. They will then play the first card and location option that will
 * increase that score above the opponent's row score. If the Player can't
 * make their score more than the opponents in any row, it passes.
 */
