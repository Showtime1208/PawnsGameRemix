...
/**
 * Strategy implementation representing the strategy of Filling the first available
 * square. It goes through squares from left to right, then top down and selects the
 * first card that can take that spot.
 */
