...
/**
 * The view interface for the PawnsBoard game.
 * It defines methods for updating the board, handling selections,
 * displaying messages, and initializing the GUI.
 */
public interface PawnsBoardViewInterface {

  /**
   * Set the listener for view events (e.g., mouse clicks, key presses).
   * Typically, the listener is implemented by the controller.
   *
