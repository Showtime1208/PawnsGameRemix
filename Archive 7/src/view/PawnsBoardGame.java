...
/**
 * The class represents the main frame combining the game board,
 * hand, and scoring panels into a single GUI.
 */
public class PawnsBoardGame extends JFrame implements PawnsBoardViewInterface {
  ...
  /**
  * Constructor for the game view. Takes in the model and prints out
  * the view representation of the game.
