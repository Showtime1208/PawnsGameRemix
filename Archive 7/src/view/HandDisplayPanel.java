 ...
 * <p>
 * This panel draws the player's cards, highlights the selected card in cyan,
 * and also draws the influence grid for each card below the card details.
 * </p>
 */
public class HandDisplayPanel extends JPanel {
  ...
  /**
   * Represents the hand display panel constructor.
   * @param parent parent.
   * @param player player.
   */
