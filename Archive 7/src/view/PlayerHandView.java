 ...
 * <p>
 * The top portion (HandDisplayPanel) shows the cards in the player's hand and supports
 * mouse clicks to select (highlighted in cyan) or unselect a card.
 * The bottom portion (CommandPanel) provides a text field and an "Execute" button where the user
 * can enter a command:
 * <ul>
