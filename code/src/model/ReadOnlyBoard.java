...
/**
 * Represents a ReadOnlyBoard for the view to use to \ prevent any changes from being made.
 */
public interface ReadOnlyBoard {
  ...
  /**
   * THROWS A NULL POINTER EXCEPTION MAKE SURE TO ACCOUNT FOR IT. Gets the winner of the game.
   *
  ...
  /**
   * Returns the card at the specified cell. If there is no card, returns null.
   */
  Card getCardAt(int row, int col);

  /**
   * Returns a list of pawns present at the specified cell. Returns an empty list if there are no
   * pawns.
   */
