...
public interface ProviderCell {
  ...
  /**
   * Adds a pawn to the current board if allowed by the rules of the game.
   * Will not add a pawn if the current number of pawns is 3, the maximum, or if
   * there is a card placed in the cell, in which case pawns are irrelevant.
   */
  void addPawn();
