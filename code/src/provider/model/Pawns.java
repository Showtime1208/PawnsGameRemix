...
/**
 * Represents the number of pawns on a board.
 * Can be 0, for no pawns, or 1, 2, or 3.
 */
public enum Pawns {
  ...
  /**
   * Increments the pawn value.
   * Pawn ZERO will return ONE, ONE returns TWO, TWO returns THREE, and THREE throws an error.
