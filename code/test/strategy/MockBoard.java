...
public class MockBoard implements Board {
  ...
  /**
   * Construct a mock Board, specifying how big it is and whether the game is over. We also store
   * row-scores for each row for each player, so that getRowScore calls can return predictable
   * values.
   */
